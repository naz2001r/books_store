...
INSERT INTO Orders
VALUES ('0001', '0019', '0001', '0001', 'НОВЕ', '2021-10-15', '2021-10-18'),
       ('0002', '0001', '0015', '0003', 'Успішно', '2021-09-25', '2021-09-28'),
	   ('0003', '0003', '0002', '0001', 'Успішно', '2021-10-02', '2021-10-04'),
	   ('0004', '0005', '0001', '0003', 'Успішно', '2021-10-03', '2021-10-06'),
	   ('0005', '0007', '0007', '0003', 'Успішно', '2021-10-09', '2021-10-11'),
	   ('0006', '0009', '0015', '0001', 'Неуспішно', '2021-10-08', '2021-10-10'),
	   ('0007', '0002', '0001', '0001', 'Доставляється', '2021-10-13', '2021-10-16'),
	   ('0008', '0012', '0003', '0003', 'НОВЕ', '2021-10-15', '2021-10-18'),
	   ('0009', '0014', '0008', '0003', 'Успішно', '2021-09-29', '2021-10-01'),
	   ('0010', '0018', '0011', '0001', 'Неуспішно', '2021-10-06', '2021-10-08'),
	   ('0011', '0020', '0015', '0003', 'Успішно', '2021-10-11', '2021-10-13'),
	   ('0012', '0021', '0004', '0001', 'Доставляється', '2021-10-11', '2021-10-15'),
	   ('0013', '0023', '0008', '0003', 'Успішно', '2021-10-05', '2021-10-08'),
	   ('0014', '0025', '0004', '0003', 'НОВЕ', '2021-10-15', '2021-10-18'),
	   ('0015', '0027', '0006', '0003', 'Доставляється', '2021-10-14', '2021-10-16'),
	   ('0016', '0029', '0010', '0001', 'НОВЕ', '2021-10-15', '2021-10-17'),
	   ('0017', '0022', '0012', '0001', 'Успішно', '2021-10-10', '2021-10-12'),
	   ('0018', '0024', '0006', '0001', 'Успішно', '2021-10-10', '2021-10-13'),
	   ('0019', '0030', '0013', '0003', 'Успішно', '2021-10-08', '2021-10-11'),
	   ('0020', '0014', '0008', '0003', 'НОВЕ', '2021-10-15', '2021-10-17'),
	   ('0021', '0001', '0001', '0001', 'Успішно', '2021-10-07', '2021-10-10'),
	   ('0022', '0009', '0015', '0003', 'Неуспішно', '2021-09-27', '2021-09-30'),
	   ('0023', '0020', '0015', '0001', 'Успішно', '2021-09-23', '2021-09-27'),
	   ('0024', '0002', '0009', '0001', 'Успішно', '2021-09-26', '2021-09-29'),
	   ('0025', '0028', '0014', '0003', 'Успішно', '2021-10-02', '2021-10-04'),
	   ('0026', '0001', '0009', '0003', 'Доставляється', '2021-10-11', '2021-10-15'),
	   ('0027', '0008', '0009', '0003', 'Успішно', '2021-09-26', '2021-09-28'),
	   ('0028', '0001', '0015', '0001', 'Успішно', '2021-10-06', '2021-10-08'),
	   ('0029', '0018', '0011', '0001', 'Успішно', '2021-10-02', '2021-10-05'),
	   ('0030', '0022', '0012', '0003', 'Успішно', '2021-10-09', '2021-10-11'),
	   ('0031', '0005', '0001', '0001', 'НОВЕ', '2021-10-15', '2021-10-18'),
	   ('0032', '0018', '0011', '0001', 'Доставляється', '2021-10-14', '2021-10-16'),
	   ('0033', '0014', '0008', '0003', 'Успішно', '2021-09-27', '2021-09-30'),
	   ('0034', '0020', '0014', '0001', 'Успішно', '2021-10-12', '2021-10-14'),
	   ('0035', '0016', '0010', '0003', 'НОВЕ', '2021-10-15', '2021-10-18'),
	   ('0036', '0001', '0008', '0001', 'Доставляється', '2021-10-13', '2021-10-16'),
	   ('0037', '0009', '0015', '0001', 'Успішно', '2021-09-30', '2021-10-02'),
	   ('0038', '0016', '0010', '0003', 'Успішно', '2021-09-30', '2021-10-03'),
	   ('0039', '0020', '0015', '0003', 'Доставляється', '2021-10-13', '2021-10-15'),
	   ('0040', '0030', '0007', '0001', 'Доставляється', '2021-10-13', '2021-10-16'),
	   ('0041', '0022', '0012', '0003', 'Успішно', '2021-10-10', '2021-10-13'),
	   ('0042', '0025', '0004', '0003', 'Доставляється', '2021-10-13', '2021-10-16'),
	   ('0043', '0005', '0001', '0001', 'Доставляється', '2021-10-14', '2021-10-16'),
	   ('0044', '0015', '0005', '0003', 'Доставляється', '2021-10-12', '2021-10-15'),
	   ('0045', '0003', '0002', '0003', 'В обробці', '2021-10-15', '2021-10-18'),
	   ('0046', '0014', '0008', '0001', 'В обробці', '2021-10-14', '2021-10-17'),
	   ('0047', '0001', '0015', '0001', 'Доставляється', '2021-09-12', '2021-09-15'),
	   ('0048', '0005', '0001', '0001', 'НОВЕ', '2021-10-15', '2021-10-17'),
	   ('0049', '0010', '0003', '0001', 'Доставляється', '2021-10-13', '2021-10-15'),
	   ('0050', '0005', '0001', '0001', 'Успішно', '2021-10-08', '2021-10-11'),
	   ('0051', '0029', '0001', '0001', 'НОВЕ', '2021-10-15', '2021-10-17'),
	   ('0052', '0028', '0001', '0001', 'Доставляється', '2021-10-14', '2021-10-16'),
	   ('0053', '0004', '0001', '0003', 'Успішно', '2021-09-26', '2021-10-02'),
	   ('0054', '0027', '0001', '0001', 'В обробці', '2021-10-14', '2021-10-17'),
	   ('0055', '0026', '0001', '0003', 'НОВЕ', '2021-10-15', '2021-10-18'),
	   ('0056', '0017', '0001', '0003', 'Доставляється', '2021-10-13', '2021-10-16'),
	   ('0057', '0013', '0005', '0003', 'Неуспішно', '2021-10-02', '2021-10-04'),
	   ('0058', '0011', '0001', '0001', 'НОВЕ', '2021-10-15', '2021-10-18'),
	   ('0059', '0006', '0009', '0003', 'Успішно', '2021-09-27', '2021-09-30'),
	   ('0060', '0004', '0001', '0001', 'Успішно', '2021-10-02', '2021-10-05');
SELECT * From Orders;
Alter Table Orders
